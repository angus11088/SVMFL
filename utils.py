...
def Args() -> argparse.Namespace:
    ...
    parser.add_argument('-fl', '--switch_FL', type = str, default = 'FedAvg', help = 'FL algorithm, from FedAvg, FedAdam, FedAMS, FedProx, MOON, FedAwS, TurboSVM, FedEFC')
    ...
    parser.add_argument('-M', '--cluster_method', type = str, default = 'KMeans', help = 'Cluster algorithm of cluster,from KMeans, KMedoids')
