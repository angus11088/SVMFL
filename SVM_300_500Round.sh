...
do
    ...
    do
        for e in 1 2 4
        do
            for global_epoch in 301 501
            do
                nohup python main_FL.py -p $project -fl TurboSVM -C $c -E $e -global_epoch $global_epoch > output/output_TurboSVM_${project}_${e}_${c}_${global_epoch}.log 2>&1
                wait
            done
        done
    done
