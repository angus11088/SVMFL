...
2. dive into `leaf/data/celeba/`, create there a folder `/data/raw/`.

3. from http://mmlab.ie.cuhk.edu.hk/projects/CelebA.html, download or request the metadata files `identity_CelebA.txt` and `list_attr_celeba.txt`, and place them in `/data/raw/` directory.
