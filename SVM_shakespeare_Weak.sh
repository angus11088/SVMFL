...
do
    ...
    do
        ...
        do
            ...
            do
                nohup python main_FL.py -p $project -fl TurboSVM -C $c -E $e -global_epoch $global_epoch --malicious 'Weak'> output/output_TurboSVM_${project}_${e}_${c}_${global_epoch}_${malicious}.log 2>&1
                wait
            done
        done
    done
