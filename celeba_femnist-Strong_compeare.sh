...
for project in celeba femnist # covid19
do
    for Method in DBSCANISO GaussianMixtureISO GaussianMixtureDBSCAN GaussianMixtureDBSCANISO
    #C 8 16 32
    #E 1 2 4
